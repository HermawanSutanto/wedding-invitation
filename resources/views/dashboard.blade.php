                ...
                @if ($invitation)
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            {{-- TAMBAHKAN LINK INI DI BAWAH STATISTIK --}}
                            <div class="p-4 bg-gray-50 border-t text-center">
                                <a href="{{ route('invitation.guestbook', $invitation) }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800">
                                    Lihat Semua Daftar Tamu & Ucapan &rarr;
                                </a>
                            </div>
                        </div>
