...
<head>
    ...
    <title>Undangan Pernikahan | John & Jane</title>
    {{-- <link rel="stylesheet" href="{{ asset('css/template1.css') }}"> --}}
    <!-- Google Fonts: Great Vibes for titles, Poppins for body -->
    <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Poppins:wght@300;400;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"/>
    <style>
        /* Pengaturan Dasar & Palet Warna Elegan */
:root {
...
/* Salin dari kode CSS sebelumnya & sesuaikan */
.quote {
    background-color: var(--bg-color);
    font-style: italic;
    font-size: 1.2em;
...
<body>
    ...
    <div class="cover" id="cover">
        ...
        <div class="cover-content">
            ...
            <h1 class="script-font">John & Jane</h1>
    ...
    <main id="main-content" style="display: none;">
        ...
        <header class="hero" id="home">
            <div class="hero-content">
                ...
                <h1 class="script-font">John & Jane</h1>
                <p class="date">25 Desember 2025</p>
            </div>
        </header>

        <section class="quote animate-on-scroll">
            <p>"Dan di antara tanda-tanda kekuasaan-Nya ialah Dia menciptakan untukmu isteri-isteri dari jenismu sendiri, supaya kamu cenderung dan merasa tenteram kepadanya..."</p>
            <h4 class="script-font">(QS. Ar-Rum: 21)</h4>
        </section>
        ...
        <section class="couple animate-on-scroll" id="couple">
            ...
            <div class="couple-container">
                <div class="couple-info animate-on-scroll">
                    <img src="images/mempelai-pria.jpg" alt="Mempelai Pria">
                    <h3 class="script-font">John Doe</h3>
                    <p>Putra Pertama dari:</p>
                    <p>Bapak John Doe Sr. & Ibu Jane Doe Sr.</p>
                </div>
                <div class="couple-separator script-font">&</div>
                <div class="couple-info animate-on-scroll" style="transition-delay: 0.2s;">
                    <img src="images/mempelai-wanita.jpg" alt="Mempelai Wanita">
                    <h3 class="script-font">Jane Smith</h3>
                    <p>Putri Kedua dari:</p>
                    <p>Bapak John Smith & Ibu Jane Smith</p>
                </div>
            </div>
        </section>
            ...
            <div class="timeline">
                <div class="timeline-item left animate-on-scroll">
                    <div class="timeline-content">
                        ...
                        <p>Juni 2022 - Kami bertemu di sebuah acara komunitas, sebuah awal yang tak terduga dari sebuah cerita indah.</p>
                    </div>
                </div>
                <div class="timeline-item right animate-on-scroll">
                    <div class="timeline-content">
                        <h3>Menjalin Hubungan</h3>
                        <p>Januari 2023 - Seiring berjalannya waktu, kami memutuskan untuk menulis babak baru dalam hidup kami bersama.</p>
                    </div>
                </div>
                <div class="timeline-item left animate-on-scroll">
                    <div class="timeline-content">
                        <h3>Lamaran</h3>
                        <p>Desember 2024 - Sebuah momen spesial saat sebuah pertanyaan dijawab dengan "Ya", mengikat janji untuk selamanya.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="event animate-on-scroll" id="event">
            ...
            <div class="event-container">
                <div class="event-card animate-on-scroll">
                    <h3>Akad Nikah</h3>
                    <p><i class="fa-solid fa-calendar-day"></i> Jumat, 25 Desember 2025</p>
                    <p><i class="fa-solid fa-clock"></i> 09:00 WIB</p>
                    <p><i class="fa-solid fa-map-marker-alt"></i> Masjid Istiqlal, Jakarta</p>
                    <a href="https://maps.app.goo.gl/" target="_blank" class="map-button">Lihat Peta</a>
                </div>
                <div class="event-card animate-on-scroll" style="transition-delay: 0.2s;">
                    <h3>Resepsi</h3>
                    <p><i class="fa-solid fa-calendar-day"></i> Jumat, 25 Desember 2025</p>
                    <p><i class="fa-solid fa-clock"></i> 18:00 WIB</p>
                    <p><i class="fa-solid fa-map-marker-alt"></i> Balai Kartini, Jakarta</p>
                    <a href="https://maps.app.goo.gl/" target="_blank" class="map-button">Lihat Peta</a>
                </div>
            </div>
        </section>
        ...
        <section class="gallery animate-on-scroll" id="gallery">
            ...
            <div class="gallery-container">
                <img src="images/gallery-1.jpg" alt="Foto Pre-wedding 1" class="gallery-item animate-on-scroll">
                <img src="images/gallery-2.jpg" alt="Foto Pre-wedding 2" class="gallery-item animate-on-scroll" style="transition-delay: 0.1s;">
                <img src="images/gallery-3.jpg" alt="Foto Pre-wedding 3" class="gallery-item animate-on-scroll" style="transition-delay: 0.2s;">
                <img src="images/gallery-4.jpg" alt="Foto Pre-wedding 4" class="gallery-item animate-on-scroll" style="transition-delay: 0.3s;">
            </div>
        </section>

        <section class="dress-code animate-on-scroll">
            <h2 class="script-font">Dress Code</h2>
            <p>Kami akan sangat berbahagia jika Anda mengenakan pakaian dengan nuansa warna berikut:</p>
            ...
            <p class="dress-code-note">Mohon untuk tidak menggunakan pakaian berwarna putih.</p>
        </section>
        
        <section class="gift animate-on-scroll">
            <h2 class="script-font">Wedding Gift</h2>
            <p>Doa restu Anda adalah hadiah terindah. Namun, jika Anda ingin memberikan tanda kasih, kami telah menyediakan amplop digital untuk memudahkan Anda.</p>
            <div class="gift-card animate-on-scroll">
                <h4><i class="fa-solid fa-building-columns"></i> Bank Central Asia</h4>
                <p id="account-number">1234567890</p>
                <p>a.n. John Doe</p>
                <button class="copy-button" data-account="1234567890">
        ...
        <section class="guestbook animate-on-scroll">
            ...
            <div class="guestbook-container" id="guestbook-container">
                <!-- Ucapan akan ditambahkan oleh JS -->
            </div>
        </section>
        ...
        <footer>
            ...
            <p class="script-font" style="font-size: 2.5em; margin: 20px 0;">John & Jane</p>
            <p>&copy; 2025. Dibuat dengan ❤.</p>
        </footer>
