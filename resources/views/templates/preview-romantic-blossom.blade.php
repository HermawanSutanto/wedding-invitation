...
<head>
    ...
    <style>
        :root {
            --bg-color: #FEFBF6;      /* Soft Ivory */
            --text-color: #5D5451;    /* Earthy Brown */
            --primary-color: #A2B29F; /* Sage Green */
            --gold-color: #D4AFB9;    /* Rose Gold */
            --accent-color: #E6B4B4;  /* Blush Pink */
        ...
        @keyframes pulse-glow {
            0%, 100% {
                transform: scale(1);
                box-shadow: 0 0 10px 0px rgba(212, 175, 185, 0.4);
            }
            50% {
                transform: scale(1.05);
                box-shadow: 0 0 20px 10px rgba(212, 175, 185, 0.6);
            }
        }
...
<body>
    ...
    <main id="main-content">
        ...
        <section id="gift" class="animate-on-scroll" style="background-color: var(--bg-color-alt);">
            <div class="container">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const invitationData = {
                ...
                groom_name: 'Aditya',
                bride_name: 'Kirana',
                cover_image: 'https://picsum.photos/seed/cover-blossom/1200/1800', 
                hero_image: 'https://picsum.photos/seed/hero-blossom/1920/1080',   
                ...
                groom_photo_path: 'https://picsum.photos/seed/groom-blossom/400/400', 
                groom_info: 'Putra Bapak Subagio & Ibu Wati',
                bride_photo_path: 'https://picsum.photos/seed/bride-blossom/400/400', 
                ...
                events: [
                    {
                        ...
                        dress_code_colors: ['#FEFBF6', '#E6B4B4', '#D4AFB9', '#A2B29F'], 
                    },
                    {
                ...
                galleries: [
                    { image_path: 'https://picsum.photos/seed/gallery1-blossom/600/800' },
                    { image_path: 'https://picsum.photos/seed/gallery2-blossom/800/600' },
                    { image_path: 'https://picsum.photos/seed/gallery3-blossom/600/600' },
                    { image_path: 'https://picsum.photos/seed/gallery4-blossom/800/600' },
                    { image_path: 'https://picsum.photos/seed/gallery5-blossom/600/800' },
                    { image_path: 'https://picsum.photos/seed/gallery6-blossom/600/600' },
                ],
                gifts: [
            ...
            const populateContent = () => {
                     ...
                     liveStreamEvents.forEach(event => {
                        liveStreamCards += `
                            <div class="event-card animate-on-scroll">
                                ...
                                <a href="${event.livestream_link}" target="_blank" class="map-button" style="background-color: var(--accent-color);">
                ...
                const colors = events[0]?.dress_code_colors || ['#FEFBF6', '#E6B4B4', '#D4AFB9', '#A2B29F'];
                ...
                if (pkg.has_rsvp) {
                    ...
                    gifts.forEach(gift => {
                        ...
                        <div class="gift-card animate-on-scroll">
                            ...
                            <button class="copy-button" data-account="${gift.account_number}">
            ...
            if (canvas) {
                ...
                const animateParticles = () => {
                    ...
                    particles.forEach(p => {
                        ...
                        ctx.fillStyle = `rgba(212, 175, 185, ${p.opacity})`;
            ...
            // --- FALLING BLOSSOM EFFECT & PARALLAX ---
            ...
            const createBlossom = () => {
                ...
                blossom.style.animationDuration = `${Math.random() * 5 + 5}s`; // 5-10 seconds
            ...
            const onScroll = () => {
                ...
                if (!ticking) {
                    window.requestAnimationFrame(() => {
                        ...
                        // Create blossoms on scroll
                        if (Math.random() > 0.7) { // Randomly create blossoms to avoid clutter
                            createBlossom();
                        }
                        ticking = false;
                    });
            ...
            openButton.addEventListener('click', () => {
                ...
                // Add scroll listener only after opening
            ...
            document.getElementById('gift-container').addEventListener('click', e => {
                ...
                navigator.clipboard.writeText(button.dataset.account).then(() => {
                    ...
                    button.style.backgroundColor = '#7a9b78'; // Success Green
                    setTimeout(() => {
